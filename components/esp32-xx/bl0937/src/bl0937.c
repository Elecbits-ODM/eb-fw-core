...
bl0937_config_t bl0937_config_default(void)
{
      ...
      c.gpio_cf  = (gpio_num_t)CONFIG_BL0937_CF_GPIO;
        c.gpio_cf1 = (gpio_num_t)CONFIG_BL0937_CF1_GPIO;
        c.gpio_sel = (gpio_num_t)CONFIG_BL0937_SEL_GPIO;
...
static void timer_cb(void *arg)
{
        ...
        int sel = (next_phase == PHASE_VOLTAGE) ? 1 : 0;
        gpio_set_level(s_ctx.cfg.gpio_sel, sel);
